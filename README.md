...
- **2024.09–12** [Withinstar.com](https://github.com/hi-shp/Withinstar) – 인스타그램 기반 익명 매칭 서비스  
  HTML/CSS/JS 기반 웹 서비스 구축·배포, Google Analytics 연동.  
  대한민국 및 캘리포니아 사업자 승인, 누적 264명 실사용, 월간 방문 1.2k [(바로가기)](https://www.withinstar.com/)  

- **2025.01-02** [부산광역시 자율운항보트 경진대회](https://www.youtube.com/watch?v=V6OAN6Mg4Mg&feature=youtu.be)  
  ROS2 기반 Python 파이프라인 단독 개발. LiDAR, GPS, IMU, 카메라 데이터를 실시간 통합해  
  쓰러스터 제어 알고리즘 구현 → 동일 코드로 두 팀이 각각 최종 1위·3위 달성

- **2025.03** [플라토 자동 로그인](https://github.com/hi-shp/plato_auto_login)  
...
- **2025.04–05** [공학입문설계](https://drive.google.com/file/d/10CEnR6pYQzOonEx9aHJ0cDH8o6rn1BDA/view) – 흔들림 보정 의자  
  6자유도 자이로 센서 + Arduino 로봇팔을 활용해 자동 흔들림 보정 기능 구현  

- **2025.06–07** [학습플러스 코칭동아리](https://drive.google.com/file/d/1Z3xmDsNLaOUo43MBICKdIz9htWLwmbgy/view)  
  Rhino로 선체 설계, 2D LiDAR 시뮬레이션 알고리즘 개발.  
  팀장으로 8주간 프로젝트 리드 → 최종 25팀 중 2위  

- **2025.08–09** [KABOAT 전국 자율운항보트 경진대회](https://github.com/hi-shp/KABOAT2025)    
  2025 부산대학교 조선해양공학과 날샘 KABOAT 팀 리더.  
  ROS2 기반 자율운항 알고리즘(장애물 판단, PID 제어, 객체 인식, 시뮬레이션) 개발  

- **2025.10–12** [선박 운동 강화학습](https://github.com/hi-shp/Data_science)    
  최적화된 장애물 회피 경로 알고리즘 도출을 위한 시뮬레이션 강화학습 환경 구현

- **2026.01-02** [스마트선박 페스티벌](https://github.com/hi-shp/kabot2026)    
   ROS2 기반 USV(Unmanned Surface Vehicle) 통합 제어 시스템 구축 및 실전 임무 수행 → 최종 2위 달성
...
- WRO 세계로봇올림피아드(RCJK) 한국 1위 
- 2026 스마트선박 페스티벌: 2위
- 2025 부산광역시 자율운항보트 경진대회: 1위 & 3위  
- 2024 PNU 창의융합 SW 해커톤: 우수상  
- 2025 부산대학교 학습플러스 코칭동아리: 2위
- 2025 BEE Maker Study Group: 활동 2위  
- 2024 글로벌 창업노마드 아이디어 경진대회: 우수상  
- 2024 해양 산업융합 PBL 아이디어 경진대회: 장려상  
- 2024 PNU SW 코딩역량강화 프로그램: 1위  
